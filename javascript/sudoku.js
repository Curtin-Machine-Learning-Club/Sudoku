 ...
 * code from above reference with only tweaks being reformatting
 */
class Sudoku
{
    constructor()
    ...
    initialize(object)
    {
        ...
        */
        object.SQUARES             = this._cross(object.ROWS, object.COLS);
        object.UNITS               = this._get_all_units(object.ROWS, object.COLS);
        object.SQUARE_UNITS_MAP    = this._get_square_units_map(object.SQUARES, object.UNITS);
        object.SQUARE_PEERS_MAP    = this._get_square_peers_map(object.SQUARES, 
                                    object.SQUARE_UNITS_MAP);
    }
